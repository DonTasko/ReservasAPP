...
const CONFIG = {
  SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbyhbzKM9rK9VeuOrOIiO_2zFA6ZZP0Kwb345o-CAecduLycSBbJFX6NEoWGnDWn-2bO/exec',
  APP_NAME: 'Don Tasko',
  VERSION: '7.0',
  DEBUG: true,
  CACHE_ENABLED: true,
...
function apiRequest(action, data = {}) {
  return new Promise((resolve, reject) => {
    ...
    if (CONFIG.DEBUG) console.log(`📤 JSONP [${action}]:`, data);
    ...
    window[callbackName] = (response) => {
      cleanup();
      if (CONFIG.DEBUG) console.log(`📥 Response [${action}]:`, response);
      resolve(response);
    };
...
if (CONFIG.DEBUG) console.log(`✅ ${CONFIG.APP_NAME} v${CONFIG.VERSION} - JSONP`);
